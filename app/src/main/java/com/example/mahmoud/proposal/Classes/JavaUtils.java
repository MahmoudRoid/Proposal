...
public class JavaUtils {
    ...
    public  String getCpuTemperature_Sony(){
    ...
    public  String getGov(){
        ...
        try {
            ...
            RandomAccessFile reader = new RandomAccessFile(govPath, "r" );
    ...
    public void setGov(Context context, String valueGov){

        boolean ok = false;
        try {

            File file = new File("/sys/devices/system/cpu/cpu0/cpufreq/scaling_governor");
            File file2 = new File("/sys/devices/system/cpu/cpu1/cpufreq/scaling_governor");
            // If file does not exists, then create it
            if (file.exists()) {
                FileWriter fw = new FileWriter(file.getAbsoluteFile());
                BufferedWriter bw = new BufferedWriter(fw);
