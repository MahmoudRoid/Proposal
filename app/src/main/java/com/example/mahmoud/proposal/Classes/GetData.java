...
//        this.CpuTemperature = JavaUtils.getInstance().getCpuTemperature_Sony();
        this.CpuTemperature = JavaUtils.getInstance().getCpuTemperature_huawei();
        ...
        try {
            ...
            myRealm.executeTransactionAsync(new Realm.Transaction() {
                ...
                public void execute(Realm realm) {
                    ...
                    // Set its fields
                    model.setCpuOneFreq(Long.parseLong(Cpu1Freq));
                    model.setCpuTwoFreq(Long.parseLong(Cpu2Freq));
                    model.setCpuThreeFreq(Long.parseLong(Cpu3Freq));
                    model.setCpuFourFreq(Long.parseLong(Cpu4Freq));
